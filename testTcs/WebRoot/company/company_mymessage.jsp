       ...
       <nav class="navbar navbar-default navbar-fixed-top">
		...
		<s:if test="#request.page==1">
			...
			<s:else>
				...
				<a class="btn btn-default">上一页</a>&nbsp;
				第<s:property value="#request.page"/>页&nbsp;
				<a class="btn btn-success" href="<%=path%>/company/Message_selectComAllMessage.action?page=<s:property value="#request.page+1"/>&key=<s:property value="#request.key"/>">下一页</a>&nbsp;
				<s:if test="#request.counts%10==0">
					<a class="btn btn-info" href="<%=path%>/company/Message_selectComAllMessage.action?page=<s:property value="#request.counts/10"/>&key=<s:property value="#request.key"/>">尾页</a>
				</s:if>
				<s:else>
					<a class="btn btn-info" href="<%=path%>/company/Message_selectComAllMessage.action?page=<s:property value="#request.counts/10+1"/>&key=<s:property value="#request.key"/>">尾页</a>
				</s:else>
			</s:else>
    	</s:if>
		<s:else>
			<s:if test="#request.page*10>=#request.counts" >
				<a class="btn btn-info" href="<%=path%>/company/Message_selectComAllMessage.action?page=1&key=<s:property value="#request.key"/>">首页</a>&nbsp;
				<a class="btn btn-success" href="<%=path%>/company/Message_selectComAllMessage.action?page=<s:property value="#request.page-1"/>&key=<s:property value="#request.key"/>">上一页</a>&nbsp;
				第<s:property value="#request.page"/>页&nbsp;
				<a class="btn btn-default">下一页</a>&nbsp;
				<a class="btn btn-default">尾页</a>
			</s:if>
			<s:else>
				...
				<a class="btn btn-success" href="<%=path%>/company/Message_selectComAllMessage.action?page=<s:property value="#request.page-1"/>&key=<s:property value="#request.key"/>">上一页</a>&nbsp;
				第<s:property value="#request.page"/>页&nbsp;
				<a class="btn btn-info" href="<%=path%>/company/Message_selectComAllMessage.action?page=<s:property value="#request.page+1"/>&key=<s:property value="#request.key"/>">下一页</a>&nbsp;
				<s:if test="#request.counts%10==0">
					<a class="btn btn-success" href="<%=path%>/company/Message_selectComAllMessage.action?page=<s:property value="#request.counts/10"/>&key=<s:property value="#request.key"/>">尾页</a>
				</s:if>
				<s:else>
					<a class="btn btn-info" href="<%=path%>/company/Message_selectComAllMessage.action?page=<s:property value="#request.counts/10+1"/>&key=<s:property value="#request.key"/>">尾页</a>
				</s:else>
