	...
	<div class="swiper-container">
		<div class="swiper-wrapper">
			<div class="swiper-slide floorone">
				<div class="ani" swiper-animate-effect="ZoomIn" swiper-animate-duration="0.5s">
					<h2>
						享受生活
					</h2>
			...
			<div class="swiper-slide floortwo">
				<ul class="index_ul">
					<li class="ani" swiper-animate-effect="lightSpeedIn" swiper-animate-duration="0.5s">
					...
					<li class="ani" swiper-animate-effect="lightSpeedIn" swiper-animate-duration="0.5s" swiper-animate-delay="0.3s">
					...
					<li class="ani" swiper-animate-effect="lightSpeedIn" swiper-animate-duration="0.5s" swiper-animate-delay="0.6s">
			...
			<div class="swiper-slide floorthree">
				<div class="contxt-title ani" swiper-animate-effect="fadeInLeftBig" swiper-animate-duration="0.7s">
					<h2>服务从“心”开始</h2>
				</div>
				<div class="contxt-con ani" swiper-animate-effect="flipInY" swiper-animate-duration="0.8s" swiper-animate-delay="0.5s">	
