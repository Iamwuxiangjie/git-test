...
<html>
  ...
  <body>
        ...
        <div class="sevice-list information container" style="padding-top: 0px">
            <h2>
                智慧社区家政服务
            </h2>
            <h4>
            ...
            <div style="margin:20px auto; width:504px;">
            <form method="post" action="user/Service_getLikeServices" class="navbar-form navbar-right">
                    	<input type="hidden" name="page" value="1"/>
  						<input type="hidden" name="ServiceTypeId" value="<s:property value='#ServiceTypeId==null?0:#ServiceTypeId'/>"/>	
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="服务名称关键字" name="likename" value="<s:property value="#likename"/>" style="width: 450px;border-color: #d9534f;"/>
                            <span class="input-group-btn">
            ...
            <div class="shop-menu clearfix" style="margin-top:70px;margin-bottom: 10px">
            <strong style="float:left;margin-left:40px">服务分类:</strong>
            <ul>
  			...
  			href="user/Service_getLikeServices?page=1&ServiceTypeId=0">全部</a></li>
                ...
                <s:if test="#request.servicetype.size>9">
                	<li class="check-more"><button id="check-more" class="btn btn-info" >查看更多</button></li>
                </s:if>
            </ul>
                ...
                <div class="box col-sm-6 col-md-3">
                    <div class="thumbnail">
                    	<s:if test="#service.serviceImg!=null">
    						<a href="<%=path%>/web/Service_forwardto.action?page=1&serviceid=<s:property value="#service.serviceId"/>"><img alt="服务图片" src="<s:property value="#service.serviceImg"/>"></a>
    					</s:if>
    					<s:else>
                        ...
                        <div class="caption">
                            <h3>
                                <s:property value="#service.serviceName"/><br><hr>
                                <small><s:property value="#service.service_serviceType.serviceTypeName"/></small>
                            </h3>
                            <p>
             		...
             		<s:if test="#nowpage>1">
    					<a class="btn btn-success" href="user/Service_getLikeServices?page=<s:property value='#nowpage-1'/>&ServiceTypeId=<s:property value='#ServiceTypeId'/>&likename=<s:property value='likename'/>" 
