						...
						<div class="thumbnail" style="padding-top: 10px;width:220px;">
							<div id="localImag">
								<s:if test="#session.loginUser.userImg==null">
									<img id="preview" width="200px" alt="用户头像" src="images/userimg.png" style="margin-bottom:5px">
								</s:if>
								<s:else>
									<img id="preview" width="200px" alt="用户头像" src="${sessionScope.loginUser.userImg }" style="margin-bottom:5px">
								</s:else>
							</div>
						</div>
							<s:form action="/user/User_upload.action" method="post"
