...
<body>
    ...
    <div class="content">
        <form action="<%=path%>/user/Order_orderPaySuccess.action?orderid=<s:property value="#request.order.orderId"/>" class="alipayform" method="POST">
            <div class="element" style="margin-top:60px;">
                <div class="legend">支付宝即时到账交易接口快速通道 </div>
            </div>
            <div class="element">
                <div class="etitle">商户订单号:</div>
                <div class="einput"><input type="text" name="WIDout_trade_no" id="out_trade_no" value="${request.order.orderNum }" disabled="disabled"></div>
                <br>
            ...
            <div class="element">
                ...
                <div class="einput"><input type="text" name="WIDsubject" value="${request.order.order_service.serviceName }" disabled="disabled"></div>
                <br>
               <!--  <div class="mark">注意：产品名称(subject)，必填(建议中文，英文，数字，不能含有特殊字符)</div> -->
            </div>
            <div class="element">
                <div class="etitle">付款金额:</div>
                <div class="einput"><input type="text" name="WIDtotal_fee" value="${request.order.orderCost }0" disabled="disabled"></div>
                <br>
                <!-- <div class="mark">注意：付款金额(total_fee)，必填(格式如：1.00,请精确到分)</div> -->
            </div>
			<div class="element">
                <div class="etitle">商品描述:</div>
                <div class="einput"><input type="text" name="WIDbody" value="${request.order.order_service.serviceExplain }" disabled="disabled"></div>
                <br>
