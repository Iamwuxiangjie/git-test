...
<html>
            ...
            <div class="personal-information">
                ...
                <div class="row">
                    <div class="avatar col-xs-12 col-sm-12 col-md-4" style="margin-top:50px">
                        <s:if test="#session.loginUser.userImg!=null">
							<a href="<%=path%>/user/user_upload.jsp">
								<img title="点击修改" width="200px" height="200px" alt="点击修改" src="${sessionScope.loginUser.userImg }">
							</a>
						</s:if>
						<s:else>
							<a href="<%=path%>/user/user_upload.jsp">
								<img title="点击修改" alt="点击修改" src="images/userimg.png">
							</a>
						</s:else>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4">
						...
						<s:else>
							<input id="like" type="hidden" value="${session.loginUser.userLike}"/>
							<select name="serviceTypeName" style="height:50px;width:100%;border:1px solid #ddd;border-radius:4px">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        ...
                        <s:if test="#session.loginUser.userAddress==null">
						...
						<s:else>
							<input id="sp" type="hidden" value="${session.loginUser.userAddress}"/>
							<select name="provinces" id="provinces" onchange="allcity()" style="height:50px;width:48%;border:1px solid #ddd;border-radius:4px">
	...
	window.onload = function() {
		...
		var str = document.getElementById("sp").value.split(" ");
		document.getElementById("op1").innerHTML = str[0];
		document.getElementById("op2").innerHTML = str[1];
		
		document.getElementById("op0").innerHTML = document.getElementById("like").value
		document.getElementById("op0").value = document.getElementById("like").value
	}
</script>
	</body>
</html>
