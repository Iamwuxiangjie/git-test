...
<!-- navbar -->
        ...
        <div class="information container">
            ...
            <center>
			<form action="<%=path%>/user/Message_sendMessageToPeople.action" method="post">
				...
				收件人:
					...
					<label style="font-size:20px;color:#666">
	...
	<%-- <form action="<%=path%>/user/Message_sendMessageToPeople.action" method="post">
		...
		收件人:
		<s:property value="#request.toPersonName" />
		<br> 标题:<input type="text" name="messageTitle"><br>
		内容:
		<textarea rows="5" cols="8" name="messageBody"></textarea>
