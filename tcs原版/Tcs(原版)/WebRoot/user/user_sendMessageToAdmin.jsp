...
<!-- navbar -->
        ...
        <div class="information container">
            ...
            <div class="personal-information">
                ...
                <center>
                <form action="<%=path%>/user/Message_sendMessageToAdmin.action" method="post">
               		<p>
                        <label style="font-size:20px">
                            客服:
                        </label>
                        <s:select name="adminName" list="#request.adminlistname" style="height:40px;width:200px;font-size:20px;border:1px solid #ddd;border-radius:4px">
						</s:select>
                    </p>
                    <p>
                        <label style="font-size:20px">
                        ...
                        <input type="text" name="messageTitle" style="height:30px;border:1px solid #ddd;border-radius:4px">
                    </p>
                    <p>
                        <textarea name="messageBody" style="resize: none;width:300px;height:200px;border:1px solid #ddd;border-radius:4px"></textarea>
                    </p>
                    ...
                    <!-- <p style="height:40px">
					<input class="button register" type="submit" value="发送" style="margin:0px 40px 10px 420px">
	...
	<%-- <form action="<%=path%>/user/Message_sendMessageToAdmin.action"
		method="post">
		<table border="1">
			<tr>
				<td>消息标题</td>
			...
			<tr>
				<td>消息内容</td>
				<td><input type="text" name="messageBody">
				</td>
			</tr>
			<s:select label="消息接收客服" name="adminName"
				list="#request.adminlistname">
			</s:select>
		</table>
		<s:fielderror />
