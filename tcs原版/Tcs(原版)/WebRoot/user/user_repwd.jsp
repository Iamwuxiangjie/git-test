 ...
 <!-- navbar -->
        ...
        <div class="information container">
            ...
            <div class="personal-information">
                ...
                <center>
                <form action="<%=path%>/user/User_rePwd.action" method="post">
                    <p>
                    ...
                    <p class="clearfix">
                    	<input class="btn btn-danger center-block" type="submit" value="修改密码">
                        <!-- <input tabindex="7" type="submit" class="button register" id="ReBtn" name="register" value="修改密码" style="margin-left:480px"/> -->
                    </p>
                    <s:fielderror />
                </form>
                </center>
                <a href="<%=path%>/user/User_refresh.action" style="font-size:20px;margin-left:20px">返回</a>
            </div>
        </div>
        <div class="footer">
