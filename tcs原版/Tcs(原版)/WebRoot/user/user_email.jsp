  ...
  <!-- navbar -->
        ...
        <div class="information container">
            ...
            <div class="personal-information">
        		...
        		<center>
        			<form action="<%=path%>/user/User_email.action" method="post">
        				<p>
       			    		<label style="font-size:20px">
                      			Email:
         	  	     		</label><br>
							<input type="text" name="userEmail" style="height:30px;width:240px;border:1px solid #ddd;border-radius:4px"> 
						</p>
						...
						<!-- <p style="height:40px">
						<input class="button register" type="submit" value="提交" style="margin:0px 40px 10px 420px">
    ...
    <%-- <form action="<%=path%>/user/User_email.action" method="post">
		Email:<input type="text" name="userEmail"> <input
			type="submit" value="提交"><input type="reset" value="清空"><br>
	</form>
	<s:fielderror />
