...
<html>
  ...
  <body>
  	<!-- navbar -->
        ...
        <div class="information container">
            ...
            <div class="personal-information">
                ...
                <center>
                <form action="<%=path%>/user/User_realName.action" method="post">
                <p>
                    <label style="font-size:20px">
				真实姓名:
					</label>
					<input type="text" name="userRealName" style="height:30px;width:300px;border:1px solid #ddd;border-radius:4px"><br>
				</p>
				<p>
                    <label style="font-size:20px">
				身份证号:
					</label>
					<input type="text" name="userIDCardNum" style="height:30px;width:300px;border:1px solid #ddd;border-radius:4px"><br>
				</p>
				...
				<!-- <p class="clearfix">
                    <input type="submit" class="button register" value="提交" style="margin-left:440px;margin-right:40px"/>
                    <input type="reset" class="button register" value="清空">
                </p> -->
				</form>
				</center>
    ...
    <%-- <form action="<%=path%>/user/User_realName.action" method="post">
		...
		身份证号:<input type="text" name="userIDCardNum"><br>
