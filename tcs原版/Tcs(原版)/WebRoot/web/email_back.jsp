  	...
  	<!-- navbar -->
        ...
        <div class="lost-password register container">
            ...
            <div class="content-body">
                <form action="<%=path %>/web/Person_toEmailBack.action" method="post">
                    <p>
                        <label for="email">
                            邮箱:
                        </label>
                        <input type="text" class="input-email" name="email" tabindex="1"/>
                    </p>
                    <p class="clearfix">
                        <input type="submit" class="button register" name="register" value="重置密码"/>
                        <s:fielderror />
                    </p>
                </form>
            </div>
