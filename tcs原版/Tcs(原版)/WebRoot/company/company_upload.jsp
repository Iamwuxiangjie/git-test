						...
						<center>
								<div id="localImag">
									<s:if test="#session.loginCompany.companyImg==null">
										<img id="preview" width="200" height="200" alt="公司图片"
											src="images/userimg.png" style="margin-bottom:5px">
									</s:if>
									<s:else>
										<img id="preview" width="200" height="200" alt="公司图片"
											src="${sessionScope.loginCompany.companyImg }" style="margin-bottom:5px">
									</s:else>
								</div>
								<s:form action="/company/Company_upload.action" method="post"
...
function setImagePreview() {          
	...
	<center>
		...
		<s:if test="#session.loginCompany.companyImg==null">
			<div id="localImag">
				<img id="preview" width="200" height="200" alt="公司头像"
		...
		<s:else>
			<div id="localImag">
				<img id="preview" width="200" height="200" alt="公司头像"
					src="${sessionScope.loginCompany.companyImg }">
			</div>
			<s:form action="/company/Company_upload.action" method="post"
				enctype="multipart/form-data">
				<s:file name="img" id="doc" onchange="javascript:setImagePreview();"></s:file>
		...
		<br> <a href="<%=path%>/company/Company_refresh.action">返回</a>
	</center>
 --%>
</body>
</html>
