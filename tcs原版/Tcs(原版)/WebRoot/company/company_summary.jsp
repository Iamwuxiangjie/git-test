...
<!-- navbar -->
        ...
        <div class="information container">
            ...
            <div class="personal-information">
                ...
                <center>
                <form action="<%=path%>/company/Company_summary.action" method="post">
                    <p>
                        <label style="font-size:20px">
                            公司简介:
                        </label><br>
                        <s:if test="#session.loginCompany.companySummary==null">
							<textarea name="companySummary" style="resize: none;width:300px;height:200px;border:1px solid #ddd;border-radius:4px"></textarea>
						</s:if>
						<s:else>
						<textarea name="companySummary" style="resize: none;width:300px;height:200px;border:1px solid #ddd;border-radius:4px">${sessionScope.loginCompany.companySummary}</textarea>
						</s:else>
                    </p>
                    ...
                    <!-- <p class="clearfix">
                        <input tabindex="7" type="submit" class="button register" value="提交" style="margin-left:420px"/>
                        <input tabindex="7" type="reset" class="button register" value="还原" onclick="javascript: return confirm('确认还原？');" style="margin-left:30px"/>
                    </p> -->
                    <s:fielderror />
                </form>
                </center>
	...
	<%-- <form action="<%=path%>/company/Company_summary.action" method="post">
		公司简介:
		<s:if test="#session.loginCompany.companySummary==null">
			<input type="text" name="companySummary">
		</s:if>
		<s:else>
			<input type="text" name="companySummary"
				value="${sessionScope.loginCompany.companySummary}">
		</s:else>

		<input type="submit" value="提交"><input type="reset" value="清空"><br>
	</form>
	<s:fielderror />
	<br>
