...
<body>
        ...
        <div class="information container">
            ...
            <div class="personal-information">
                ...
                <form action="<%=path%>/company/Company_setType.action" method="post">
                    ...
                    <input class="btn btn-danger center-block" type="submit" value="提交">
                   <!--  <input class="button register" type="submit" value="提交" style="margin-left:440px"> --><br><br>
	...
	<%-- <form action="<%=path%>/company/Company_setType.action" method="post">
		...
		<s:select label="类型:" name="facilitatorType"
			list="#session.facilitatorType" listValue="facilitatorTypeName">
		</s:select>
		<s:fielderror />
