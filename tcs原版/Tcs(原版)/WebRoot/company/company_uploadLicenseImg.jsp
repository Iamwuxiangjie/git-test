            ...
            <div class="personal-information">
                ...
                <div class="row">
                    <font color="red"><s:fielderror /></font>
						<center>
							<div id="localImag">
								<img id="preview" width="200" height="200" alt="公司执照" 
								src="./defaultImg/ic_launcher.png" style="margin-bottom:5px">
							</div>
...
function setImagePreview() {          
	...
	<%-- <center>
		...
		<s:form action="/company/Company_uploadLicenseImg.action"
