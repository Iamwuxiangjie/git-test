            ...
            <div class="personal-information">
				...
				method="post" enctype="multipart/form-data">
				 <p>
                    ...
                    <%-- <p class="clearfix">
                    <input class="button register" type="submit" id="updateService" value="确认修改"
					onclick="javascript: return confirm('确认修改？');" style="margin-left:420px">
					<input class="button register" type="reset" value="还原"
					onclick="javascript: return confirm('确认还原？');" style="margin-left:40px">
                    </p>
                    <s:fielderror /> --%>
                </form>
                </center>
